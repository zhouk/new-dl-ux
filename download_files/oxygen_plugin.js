var is_staging = String(window.location).match(/students-stg.autodesk.com/g); 

if (is_staging == null) { 
	// PRODUCTION
  var adsk_endpoint = 'https://accounts.autodesk.com/SignIn';
	var consumer_key = '6e5c00bf-98cb-497b-9419-ac507fd6d50a';
	var registration_url = "http://students.autodesk.com/?nd=register_loading";
	var site_scope = "students.autodesk.com";
} else {
	// STAGING
  var adsk_endpoint = 'https://accounts-staging.autodesk.com/SignIn';
	var consumer_key = '324b9cea-c732-49a4-a70b-176115061eaf';
	var registration_url = "http://students-stg.autodesk.com/?nd=register_loading";
	var site_scope = "students-stg.autodesk.com";
}
...
var OXYGEN_OPTIONS = {
  ...
  provider: 'autodesk',
  providers_endpoint: {
    autodesk: adsk_endpoint
  },
  //openid_response: 'oxygen_openid_response.html',
  //refresh_response: 'oxygen_refresh_response.html'
  openid_response: 'ama/orig/oxygen/oxygen_openid_response.html',
  refresh_response: 'ama/orig/oxygen/oxygen_refresh_response.html'
};
...
var OxygenOverlay = function(options) {
  var default_options = {
    ...
    close_button: {
      size: 24,
      image: 'url("ama/orig/oxygen/resources/close_24.png")'
    }
  };
        ...
        getBaseOpenIDProviderURL: function(provider, immediate) {
          var providerURL = options.providers_endpoint[provider] +
                            ...
                            "&openid.ns.ax=" + encodeURIComponent("http://openid.net/srv/ax/1.0") +
														"&openid.ns.alias6=" + encodeURIComponent("http://autodesk.com/openid/ext/regurl/1.0") +
														"&openid.alias6.x_openid_registrationurl=" + encodeURIComponent(registration_url) +
														"&openid.ns.alias4=" + encodeURIComponent("http://specs.openid.net/extensions/oauth/1.0") + 
														"&openid.alias4.consumer=" + consumer_key +
														"&openid.alias4.scope=" + site_scope + 
